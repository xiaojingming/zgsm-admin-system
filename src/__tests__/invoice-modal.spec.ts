...
describe('InvoiceModal', () => {
    ...
    describe('initial state', () => {
        ...
        it('should not show mobile field for company header type', () => {
            const wrapper = createWrapper();
            const vm = wrapper.vm as any;

            expect(vm.isCompany).toBe(true);
            expect(vm.formData.mobile).toBe('');
        });
    });
    ...
    describe('form submission', () => {
        it('should assemble request data correctly for company type', async () => {
        ...
        it('should assemble request data correctly for personal type', async () => {
            ...
            vm.formData.mobile = '13800138000';
            ...
            expect(callData.receive_phone).toBe('13800138000');
